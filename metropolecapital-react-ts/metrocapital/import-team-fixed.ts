/**
 * Импорт Team с правильными _key
 */
...
async function importTeam() {
  console.log('🚀 Импортирую Team с правильными ключами...\n')
  ...
  try {
      ...
      founder: {
        ...
        bio: [
          ...
          },
          {
            ...
            _type: 'block',
            children: [
              {_key: 'bio-3-1', _type: 'span', text: 'Victoria is the creator of '},
              {_key: 'bio-3-2', _type: 'span', marks: ['strong'], text: 'The Venture Triad of Trade-offs™'},
              {_key: 'bio-3-3', _type: 'span', text: ', a strategic framework helping founders navigate key decisions on growth, IP, and capital. She has advised international forums, accelerators, and universities, and authored '},
              {_key: 'bio-3-4', _type: 'span', marks: ['em'], text: 'Raise and Rise: Funding Sources for Your Startup in the Era of Digital Transformation & Blockchain.'},
            ],
            style: 'normal',
          },
        ],
    ...
    console.log('👥 Advisory Board: 3 члена с фото и биографиями')
    console.log('🔑 Все ключи добавлены!')

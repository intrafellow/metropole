/**
 * Импорт контента Events страницы
 */
...
const eventsContent = {
  ...
  // Галерея - оставляем пустым, т.к. в React используются локальные импорты
  galleryItems: [],
}

async function importEvents() {
  console.log('🚀 Импортирую Events...')
  
  try {
    await client.createOrReplace(eventsContent)
    console.log('✅ Events импортирован!')
  } catch (error) {

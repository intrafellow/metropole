...
export default function Header() {
  ...
  /* === Слушатели глобальных событий от Home.tsx === */
  useEffect(() => {
    const open = () => setMenuOpen(true);
    const close = () => setMenuOpen(false);
    const toggle = () => setMenuOpen(v => !v);

    window.addEventListener("mcg:openMenu", open as EventListener);
    window.addEventListener("mcg:closeMenu", close as EventListener);
    window.addEventListener("mcg:toggleMenu", toggle as EventListener);

    return () => {
      window.removeEventListener("mcg:openMenu", open as EventListener);
      window.removeEventListener("mcg:closeMenu", close as EventListener);
      window.removeEventListener("mcg:toggleMenu", toggle as EventListener);
    };
  }, []);
    ...
    >
      ...
      <div className="mcg-container mcg-header__inner">
        ...
        <div className="mcg-socials" aria-label="Social links">
          <a className="mcg-socials__btn" href="https://www.linkedin.com/in/victoriametropolecapital/" target="_blank" aria-label="LinkedIn" rel="noreferrer">
          ...
          <a className="mcg-socials__btn" href="https://x.com/fundingsummit/" target="_blank" aria-label="Twitter/X" rel="noreferrer">
            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
              <path fill="currentColor" d="M20.9 2H16l-4 6.6L7.1 2H3l6.7 10.1L3.3 22H8l4.3-7 4.6 7h4.1l-7.2-10.8L20.9 2z"/>
            </svg>
          </a>
          <a className="mcg-socials__btn" href="https://www.facebook.com/WorldFundingSummit/" target="_blank" aria-label="Facebook" rel="noreferrer">
            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
